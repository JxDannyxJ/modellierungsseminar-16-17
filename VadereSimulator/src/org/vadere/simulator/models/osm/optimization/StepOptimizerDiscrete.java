...
public class StepOptimizerDiscrete implements StepOptimizer{
    ...
    /**
     * Computes next position for an Agent.
     * First the agent dependent discrete shape points are computed.
     * Then for each discrete Point its potential is evaluated.
     * If the new position and its potential are better than the current one, the result is the new position.
     * If the old position is the best solution, the result is the old position.
     *
