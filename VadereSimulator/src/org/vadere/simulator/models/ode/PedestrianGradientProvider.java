...
public interface PedestrianGradientProvider {
	 ...
	 * @param currentPed current pedestrian, if any
	 ...
	 * done.
	 *
	 * @param pedestrianData the current solution to the differential equation system
	 * @param Npersons       number of pedestrians in the current solution
	 */
