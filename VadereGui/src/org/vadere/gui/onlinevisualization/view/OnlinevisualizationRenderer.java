...
/**
 * This Class draws Agents while the simulation is running.
 * 
 *
 */
...
public class OnlinevisualizationRenderer extends SimulationRenderer {
	...
	/*
	 * This method also rotate the graphic if the direction of the agent changes.
	 * There is no rotation for circles
	 * 
	 */
